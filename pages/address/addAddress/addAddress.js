...
Page({
  ...
  updateFormSubmit:function(e){//改地址
    ...
    app.alert('请填写详细地址')
      ...
      wx.request({
        url: appUrl + '/index.php/index/useraddress/upt_address',
        data: {
          "id":this.data.id,
          "porvince": province,
          "city": city,
  ...
  formSubmit: function (e) {//新增地址
    ...
    app.alert('请填写详细地址')
      ...
      wx.request({
        url: appUrl + '/index.php/index/useraddress/add_address',
        data: {
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: appUrl + '/index.php/index/useraddress/select_address',
      data: {
        "id": id
      },
      success: (res) => {
